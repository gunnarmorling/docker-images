...
if [[ -z "$CLUSTER_ID" ]]; then
    echo "Starting in ZooKeeper mode."
    CONFIG_FILE=config/server.properties
else
    echo "Starting in KRaft mode."
...
unset HOST_NAME ADVERTISED_HOST_NAME KAFKA_HOST_NAME KAFKA_ADVERTISED_HOST_NAME PORT ADVERTISED_PORT KAFKA_PORT KAFKA_ADVERTISED_PORT CONTROLLER_PORT
